...
//			System.out.println("-----------------------");
	...
	public void cargarCasilleroMonedaPositivo() {
		assertEquals(tab.getCasilleros().get(1).getClass(), new MonedaCasillero(0, 1).getClass());
	...
	public void cargarCasilleroMonedaNegativo() {
		assertEquals(tab.getCasilleros().get(71).getClass(), new MonedaCasillero(0, 1).getClass());
...
//		assertEquals(tab.getCasilleros().get(31).getClass(), new BifurcacionCasillero(0).getClass());
...
//	}
	...
	public void cargarCasilleroTeleport() {
		assertEquals(tab.getCasilleros().get(37).getClass(), new TeleportCasillero(0).getClass());
	}

	@Test
	public void cargarRandomMaloCasillero() {
		assertEquals(tab.getCasilleros().get(63).getClass(), new RandomMaloCasillero(0).getClass());
	}

	@Test
	public void cargarItemCasillero() {
		assertEquals(tab.getCasilleros().get(44).getClass(), new ItemCasillero(0).getClass());
	}

	@Test
	public void cargarTiendaCasillero() {
		assertEquals(tab.getCasilleros().get(38).getClass(), new TiendaCasillero(0).getClass());
	}

	@Test
	public void cargarHurtoCasillero() {
		assertEquals(tab.getCasilleros().get(67).getClass(), new HurtoCasillero(0).getClass());
	}

	@Test
	public void cargarEstrellaCasillero() {
		assertEquals(tab.getCasilleros().get(9).getClass(), new EstrellaCasillero(0, tab).getClass());
	}
